...
<div class="wp-block-column"><!-- wp:heading {"level":1,"fontSize":"display-large"} -->
<h1 class="wp-block-heading has-display-large-font-size"><?php esc_html_e('Journal', 'daniloparrajr-theme');?></h1>
<!-- /wp:heading -->
